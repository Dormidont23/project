...
Развернем два сервера баз данных: master и slave. Настроим между ними репликацию, в режиме Primary - Secondary.
...
Создадим на сервере два каталога, где будем хранить резервные копии веб-сайта и базы данных.
...
Для восстановления данных из резервной копии сайта, написан playbook `playbook-backup-web.yml`. Переменные необходимые для работы роли, хранятся в общем файле `var.yml`. 
```
...
## **Установка и настройка логирования</summary**
